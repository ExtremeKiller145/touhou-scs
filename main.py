...
enemy4_attack = (Component("Enemy4_Attack", unknown_g(), 5)
    ...
    .set_context(target=enemy4g)
        ...
        .GotoGroup(0.1, stop_pos_right, t=1, type=e.Easing.EASE_OUT, rate=1.5)
    .clear_context()
    .instant.Line(1.3, simple_aimed, enemy4g, e.PLR, lib.bullet4, numBullets=10, fastestTime=1.5, slowestTime=3, dist=480)
    .instant.Line(2.0, simple_aimed, enemy4g, e.PLR, lib.bullet4, numBullets=10, fastestTime=1.5, slowestTime=3, dist=480)
    .set_context(target=enemy4g)
