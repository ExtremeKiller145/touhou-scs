...
(testRadialComp
    ...
    .start_target_context(e.EMPTY_BULLET)
        .GotoGroup(0, e.EMPTY_EMITTER, t=0)
        .Toggle(e.TICK, True)
        .Alpha(0, t=0, opacity=0)
        .Alpha(e.TICK, t=1, opacity=100)
        .Scale(0, factor=2, t=0.5, reverse=True)
        .PointToGroup(e.TICK, e.EMPTY_TARGET_GROUP)
        .PointToGroup(0.3, e.EMPTY_TARGET_GROUP)
        .MoveTowards(0.3, e.EMPTY_TARGET_GROUP,
            t=1.8, type=e.Easing.EASE_IN_OUT, rate=2.01, dist=70)
        .Pulse(2.1, HSB(54, 124, 156), fadeIn=0.1, t=0.1, fadeOut=0.3)
        .MoveTowards(2.1, e.EMPTY_TARGET_GROUP,
...
(test2
    ...
    .start_target_context(e.EMPTY_BULLET)
        .GotoGroup(0, e.EMPTY_EMITTER, t=0)
        .Scale(0, factor=4, t=0.3, hold=0, reverse=True)
        .Toggle(e.TICK, True)
        .Alpha(0, t=0, opacity=0)
        .Alpha(e.TICK, t=1, opacity=100)
        .PointToGroup(e.TICK, e.EMPTY_TARGET_GROUP)
        ...
        .MoveTowards(0.3, e.EMPTY_TARGET_GROUP,
            t=1.8, type=e.Easing.EASE_IN_OUT, rate=2.01, dist=70)
        .Pulse(0, rgb(0,0,255), fadeIn=0, t=10, fadeOut=0)
        .Pulse(2.1, HSB(64, 24, 156), fadeIn=0.1, t=0.1, fadeOut=0.4)
        .MoveTowards(2.5, e.PLR,
            t=6, type=e.Easing.EASE_IN, rate=2.01, dist=400)
        .PointToGroup(2.4, e.PLR, t=0.3)
    .end_target_context()
)
...
test_line = (Component("TestLine", unknown_g(), 5)
    ...
    .start_target_context(e.EMPTY_BULLET)
        ...
        .Scale(0, factor=3, t=1.5, reverse=True)
        .Pulse(0, rgb(200,100,0), t=10)
        .Alpha(0, t=0, opacity=0)
        .Toggle(e.TICK, True)
...
# (main
#     .assert_spawn_order(True)
#     .start_target_context(c1.all)
#         .GotoGroup(0, emitter, t=0)
#     .end_target_context()
#     .Spawn(0, Stage.stage1, True)
#     .start_target_context(emitter)
...
#     .end_target_context()
#     .start_target_context(e.EMPTY_TARGET_GROUP)
